...
INSTALLED_APPS = [
    ...
    'django_extensions',  # Additional features
    'channels',
]
...
# CACHES = {
#     'default': {
#         'BACKEND': 'django_redis.cache.RedisCache',  #  FIXED
#         'LOCATION': config('REDIS_URL', default='redis://127.0.0.1:6379/1'),
#         'OPTIONS': {
#             'CLIENT_CLASS': 'django_redis.client.DefaultClient',
#         },
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Advanced Employee Management System with Chat, Performance Reviews, and Leave Management',
    'VERSION': '1.0.0',
